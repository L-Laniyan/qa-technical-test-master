...
#line hidden
                ...
                table10.AddRow(new string[] {
                            ...
                            "1"});
#line 6
testRunner.And("the response should contain my specify product details", ((string)(null)), table10, "And ");
#line hidden
            }
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Verifying I can\'t get a product from the application with an invalided product co" +
            "de")]
        public virtual void VerifyingICantGetAProductFromTheApplicationWithAnInvalidedProductCode()
        {
            string[] tagsOfScenario = ((string[])(null));
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verifying I can\'t get a product from the application with an invalided product co" +
                    "de", null, ((string[])(null)));
#line 11
this.ScenarioInitialize(scenarioInfo);
#line hidden
